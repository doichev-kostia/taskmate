...
class CookieService {
	 ...
	 */
	public static get<Options extends GetOptions>(key: string, options?: Options): ReturnType<Options> {
	...
	public static set<T>(key: string, value: T, options?: Cookies.CookieAttributes) {
